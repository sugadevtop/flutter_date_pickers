...
class RangePicker extends StatelessWidget {
  ...
  RangePicker(
      ...
      : assert(selectedPeriod != null),
        ...
        assert(!selectedPeriod.start.isBefore(firstDate.subtract(Duration(days: 1)))),
        assert(!selectedPeriod.end.isAfter(lastDate.add(Duration(days: 1)))),
        super(key: key);
  ...
  Widget build(BuildContext context) {
    ISelectablePicker<DatePeriod> rangeSelectablePicker =
        RangeSelectable(selectedPeriod, firstDate, lastDate, selectableDayPredicate: selectableDayPredicate);
